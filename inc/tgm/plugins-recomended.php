...
add_action( 'tgmpa_register', 'fitness_passion_register_required_plugins' );
 ...
 */
function fitness_passion_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'fitness-passion',                 // Unique ID for hashing notices for multiple instances of TGMPA.
