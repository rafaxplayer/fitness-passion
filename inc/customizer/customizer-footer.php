...
if ( ! defined( 'ABSPATH' ) ) { exit; }
 ...
 $wp_customize->add_section( 'fitness_passion_footer_section' , array(
    'title'      => esc_html__('Footer Options','fitness-passion'),
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'fitness_passion_footer_info_control', array(
    'label'      => esc_html__( 'Text for footer info ', 'fitness-passion' ),
    'description'=> esc_html__('You can use valid html code','fitness-passion'),
...
$wp_customize->add_control( new Fitness_Passion_Toggle_Switch_Custom_control( $wp_customize, 'fitness_passion_footer_show_social_control', array(
